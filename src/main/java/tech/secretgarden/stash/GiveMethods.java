...
//    String add = "added";
//
////    public void giveSinglePlayer(StashCmdContents contents) {
...
////    }
//
//    public void giveByTime(String giver, String[] args, ItemStack item, String itemName, Player player) {
...
//                //parse the string and return an int
//
//                //----------------------------------------------------HOURS---------------------------------------------------------------------------------------
...
//                    addItemUsingList(uuidList, number, item, giver, itemName);
//                    return;
//                }
//                //----------------------------------------------------DAYS-------------------------------------------------------------------------------------
